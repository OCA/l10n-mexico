...
#             'payment_method_line_id': self.payment_method_line.id,  # Set the payment method line
#         })
#
...
#         self.payment.write({'cfdi_document_id': self.env['l10n_mx_cfdi.document'].create({}).id})
#
...
#         self.payment.move_type = 'entry'
#         self.payment.is_reconciled = True
#         self.payment.reconciled_invoice_ids = [(0, 0, {'related_cert_ids': [(0, 0, {'type': 'I', 'state': 'published', 'receiver_id': self.partner.id})]})]
#
