...
class TestAccountMoveLine(TransactionCase):
    ...
    def setUp(self):
        ...
        self.move_line_1_vals = {
            ...
            'debit': 200,
            'account_id': self.env.ref('account.data_account_type_revenue').id,  # Example revenue account
        }
        ...
        self.move_line_2_vals = {
            ...
            # 'tax_ids': [(6, 0, [self.tax.id])],
            'credit': 200,
            'account_id': self.env.ref('account.data_account_type_current_assets').id,  # Example asset account
        }
    ...
    def test_compute_cfdi_fields(self):
        ...
        move_line_1 = move.line_ids.filtered(lambda line: line.name == 'Test Move Line 1')
        move_line_2 = move.line_ids.filtered(lambda line: line.name == 'Test Move Line 2')
