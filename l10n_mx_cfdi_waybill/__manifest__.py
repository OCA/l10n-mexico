# -*- coding: utf-8 -*-
{
    ...
    'summary': """Provee soporte para generación de cartas porte con gestión de flotas simplificada.""",
    ...
    'category': 'Stock',
    'version': '19.0.0.0.1',
    'depends': ['base', 'base_geolocalize', 'base_address_extended', 'stock', 'l10n_mx_cfdi_account'],
    'data': [
