...
class CFDITransporter(models.Model):
    ...
    driving_license = fields.Char(string='Licencia de Conducir', readonly=False,
    ...
    parte_transporte_ids = fields.Many2many('l10n_mx_catalogs.c_parte_transporte', string='Partes de Transporte', relation='cfdi_transporter_parte_transporte_rel')
